package com.ane.expresstokenapp.widget.viewgroup;
...
import com.ane.expresstokenapp.widget.common.NoDoubleClickListener;
...
public class TitleBar extends RelativeLayout {
    ...
    protected void setListener() {
        mLeftCtv.setOnClickListener(new NoDoubleClickListener() {
            @Override
        ...
        mTitleCtv.setOnClickListener(new NoDoubleClickListener() {
            @Override
            public void onNoDoubleClick(View v) {
                if (mDelegate != null) {
        ...
        mRightCtv.setOnClickListener(new NoDoubleClickListener() {
            @Override
            public void onNoDoubleClick(View v) {
                if (mDelegate != null) {
        ...
        mRightSecondaryCtv.setOnClickListener(new NoDoubleClickListener() {
            @Override
            public void onNoDoubleClick(View v) {
                if (mDelegate != null) {
    ...
    protected void initAttr(int attr, TypedArray typedArray) {
        ...
        } else if (attr == R.styleable.TitleBar_titlebar_rightSecondaryText) {
        ...
        } else if (attr == R.styleable.TitleBar_titlebar_rightSecondaryDrawable) {
